  ...
  return (
    <main className="font-sans">
      ...
      <section
        ...
        style={{ backgroundImage: "url('/images/africa-hero.jpg')" }}
      >
      ...
      <section className="bg-white py-16 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto px-4">
          {[
            { img: '/images/traditional.jpg', title: 'Traditional Celebration', subtitle: 'Unity in Culture' },
            { img: '/images/future.jpg', title: 'Future Leaders', subtitle: 'Driven by Excellence' },
            { img: '/images/pride.jpg', title: 'Cultural Pride', subtitle: 'Vibrant Traditions' },
            { img: '/images/spirit.jpg', title: 'Community Spirit', subtitle: 'Together We Rise' },
